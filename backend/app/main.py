...
from .ml_enrichment import (
    ...
    list_datasets,
    load_enriched_mosques,
    save_uploaded_dataset,
    set_active_dataset_id,
    slugify_dataset_name,
)
from .osm_graph import DEFAULT_GRAPHML, build_osm_graph_for_bbox, build_osm_graph_for_route, graph_bounds, haversine_km
from .routing_osm import route_to_mosque, route_via_osm_dijkstra
from .schemas import BuildOsmRequest, BuildOsmRouteRequest, NearestMosquesRequest, RouteRequest, RouteToMosqueRequest

app = FastAPI(
    title="iMosque OSM Dijkstra ML Web API",
    description=(
        "Backend untuk upload/switch dataset real-time, AI/ML-enriched mosque dataset, "
